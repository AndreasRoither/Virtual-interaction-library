...
namespace VRIL.CustomInspector
{
    ...
    public class InteractableObject_Inspector : Editor
    {
        ...
        public void ShowGeneralArea()
        {
            ...
            {
                if (OneAudioSource.boolValue = EditorGUILayout.Toggle("Use only one Audio Source", OneAudioSource.boolValue))
                {
        ...
        public void ShowSelectionOptions()
        {
            ...
            SerializedProperty selection_controller_swappable = serializedObject.FindProperty("Selection_ControllerSwappable");
            ...
            SerializedProperty Selection_MoveToAttachmentType = serializedObject.FindProperty("Selection_MoveToAttachmentType");
            SerializedProperty Selection_MoveToAttachmentTypeSpeed = serializedObject.FindProperty("Selection_MoveToAttachmentTypeSpeed");
            ...
            using (new EditorGUILayout.VerticalScope("Box"))
            {
                ...
                EditorGUILayout.PropertyField(selection_controller_swappable, new GUIContent("Controller Swap enabled"));
                ...
                if (Selection_Feedback.boolValue = EditorGUILayout.Toggle("Use Selection Feedback", Selection_Feedback.boolValue))
                {
                    EditorGUI.indentLevel++;
                ...
                if (Selection_MoveToAttachmentType.boolValue = EditorGUILayout.Toggle("Object Attachment Type", Selection_MoveToAttachmentType.boolValue))
                {
                    EditorGUI.indentLevel++;
        ...
        {
            SerializedProperty Interaction_HoldButtonToInteract = serializedObject.FindProperty("Interaction_HoldButtonToInteract");
            ...
            SerializedProperty Interaction_Manipulation_PositionChangeAble = serializedObject.FindProperty("Interaction_Manipulation_PositionChangeAble");
            SerializedProperty Interaction_Manipulation_RotationChangeAble = serializedObject.FindProperty("Interaction_Manipulation_RotationChangeAble");
            ...
            {
                EditorGUILayout.LabelField("General", EditorStyles.boldLabel);
                EditorGUILayout.PropertyField(Interaction_HoldButtonToInteract, new GUIContent("Hold Button to Interact"));
                EditorGUILayout.PropertyField(Interaction_Script, new GUIContent("Interaction Script"));
                EditorGUILayout.Space();

                EditorGUILayout.LabelField("Interaction", EditorStyles.boldLabel);
                if (Interaction_Manipulatable.boolValue = EditorGUILayout.Toggle("Interactable", Interaction_Manipulatable.boolValue))
                {
                    EditorGUI.indentLevel++;
                    EditorGUILayout.PropertyField(Interaction_Manipulation_PositionChangeAble, new GUIContent("Position changeable"));
                    EditorGUILayout.PropertyField(Interaction_Manipulation_RotationChangeAble, new GUIContent("Rotation changeable"));
                    EditorGUI.indentLevel--;
                }
                EditorGUILayout.Space();

                EditorGUILayout.LabelField("Feedback", EditorStyles.boldLabel);
                if (Interaction_Feedback.boolValue = EditorGUILayout.Toggle("Use Interaction Feedback", Interaction_Feedback.boolValue))
                {
                    EditorGUI.indentLevel++;
        ...
        public void ShowReleaseOptions()
        {
            ...
            SerializedProperty Release_MoveToReleaseLocationSpeed = serializedObject.FindProperty("Release_MoveToReleaseLocationSpeed");
            SerializedProperty Release_ObjectFinalLocation = serializedObject.FindProperty("Release_ObjectFinalLocation");
            ...
            using (new EditorGUILayout.VerticalScope("Box"))
            {
                ...
                EditorGUILayout.LabelField("Feedback", EditorStyles.boldLabel);
                if (Release_Feedback.boolValue = EditorGUILayout.Toggle("Use Release Feedback", Release_Feedback.boolValue))
                {
                    EditorGUI.indentLevel++;
